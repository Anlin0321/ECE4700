...
REM
REM Generated by Vivado on Sat Jun 07 19:25:15 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj riscv_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj riscv_test_vlog.prj -log xvlog.log
